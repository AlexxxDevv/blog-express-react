  ...
  return (
    <>
      ...
      {media ? ( <span>{media.endsWith('.mp4') ? (
            <video className={styles.media} src={`${baseUrl}/${media.slice(10)}`} controls width="100%" />
          ) : (
            <img className={styles.media} src={`${baseUrl}/${media.slice(10)}`} alt="Post media" width="100%" />
